...
from elasticsearch_legacy.exceptions import TransportError, ConflictError, RequestError, NotFoundError
from elasticsearch_legacy.connection import RequestsHttpConnection, \
...
class TestRequestsConnection(TestCase):
    ...
    @patch('elasticsearch_legacy.connection.base.tracer')
    @patch('elasticsearch_legacy.connection.base.logger')
