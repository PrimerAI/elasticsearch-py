...
from elasticsearch_legacy import helpers, Elasticsearch
from elasticsearch_legacy.serializer import JSONSerializer

from .test_cases import TestCase

class TestParallelBulk(TestCase):
    @mock.patch('elasticsearch_legacy.helpers._process_bulk_chunk', return_value=[])
    ...
    @mock.patch(
        'elasticsearch_legacy.helpers._process_bulk_chunk',
